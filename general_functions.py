...
def get_parser():
    ...
    parser.add_argument('--n_configs', type=int, default=15, help='Number of stimulus conditions')
    ...
    parser.add_argument('--tau_sigma1', type=int, default=10, help='Value for tau_sigma1')
    parser.add_argument('--tau_sigma2', type=int, default=10, help='Value for tau_sigma2')
    parser.add_argument('--tau_beta', type=int, default=10, help='Value for tau_beta')
    parser.add_argument('--tau_budget', type=int, default=10, help='Value for tau_tau_budget')
